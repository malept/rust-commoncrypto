...
const TO_HASH_SHA256: &'static str = concat!(
    "d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb76",
    "2d02d0bf37c9e592"
);
const TO_HASH_SHA384: &'static str = concat!(
    "ca737f1014a48f4c0b6dd43cb177b0afd9e5169367544c494011e3317dbf9a509cb1e5dc1e85a941bbee",
    "3d7f2afbc9b1"
);
const TO_HASH_SHA512: &'static str = concat!(
    "07e547d9586f6a73f73fbac0435ed76951218fb7d0c8d788a309d785436bbb642e93a252a954f2391254",
    "7d1e8a3b5ed6e1bfd7097821233fa0538f3db854fee6"
);
    ...
    (
        ...
        fn $test_name() {
            ...
            unsafe {
                ...
                assert_eq!(
                    commoncrypto_sys::$update_func(&mut ctx, TO_HASH.as_ptr(), TO_HASH.len()),
                    1
                );
...
macro_rules! test_ccdigest {
    (
        ...
        fn $test_name() {
            ...
            unsafe {
                assert_eq!(
                    commoncrypto_sys::CCDigest(
                        commoncrypto_sys::CCDigestAlgorithm::$algorithm,
                        TO_HASH.as_ptr(),
                        TO_HASH.len(),
                        md.as_mut_ptr()
                    ),
...
test_ccdigestgetoutputsize!(
    sha384_ccdigestoutputsize,
    kCCDigestSHA384,
    SHA384_DIGEST_LENGTH
);
test_ccdigestgetoutputsize!(
    sha512_ccdigestoutputsize,
    kCCDigestSHA512,
    SHA512_DIGEST_LENGTH
);
